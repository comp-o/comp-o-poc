...
public class ServiceComposer {
    ...
    private static final Resource COMPOSABLE_PERFORM = ResourceFactory.createResource("https://comp-o.github.io/comp-o#ComposablePerform");
    ...
    private static boolean isNotComposableOwlsPredicate(Statement statement) {
        return !statement.getPredicate().getURI().contains("https://comp-o.github.io/comp-o");
    }
    ...
    private static boolean isNotTypeComposableOwls(Statement statement) {
        return !statement.getPredicate().getURI().equals(TYPE.getURI())
                ...
                && !statement.getObject().asResource().getURI().contains("https://comp-o.github.io/comp-o"));
    }
    ...
    private static void writeModel(Model model, String fileName) {
        ...
        model.setNsPrefix("comp-o", "https://comp-o.github.io/comp-o#");
